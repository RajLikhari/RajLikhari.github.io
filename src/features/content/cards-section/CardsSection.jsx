...
function CardsSection({ title = "", description = "", cards = [] }) {
  return (
    <div class="flex flex-col items-center justify-center mt-20">
      <h1 class="uppercase text-center text-white text-lg sm:text-xl font-bold mb-3">{title}</h1>
      <h2 class="text-white text-md sm:text-lg text-center mb-10 sm:w-8/10">{description}</h2>
